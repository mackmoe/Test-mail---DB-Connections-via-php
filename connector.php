...
Modify Date: 08/23/2014
Creater: Mo Nash
Last Modified: Alex Edwards
...
<html>
  ...
  <body>
    <h1>E-Mail & Database Connectivity Troubleshooting</h1>
    <table cellspacing="0">
      <tr>
        <td style="border-right: 1px solid #CCC;">Send Mail (smtp auth)</td>
      ...
      <tr>
        ...
        <td style="border-right: 1px solid #CCC;">
          <form action="connector.php" method="post">
              ...
              Send Mail To:<br />
              <input type="text" name="recipient" value="" maxlength="100" /><br />
        ...
        <td>
          <form action="connector.php" method="post">
            ...
            Send Mail to:<br />
            <input type="text" name="sendmailto" value="" maxlength="100" /><br />

            <small>Image is case sensitive!</small><br />
            ...
            <a href="#" onclick="document.getElementById('captcha2').src = './securimage/securimage_show.php?' + Math.random(); return false">[ Different Image ]</a><br />
    ...
    ?>
      <tr>
        <td style="border-right: 1px solid #CCC;">MySQL (mysql_connect)</td>
